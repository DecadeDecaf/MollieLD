var right = keyboard_check(ord("D")) || keyboard_check(vk_right) || gamepad_axis_value(0, gp_axislh) > 0.5
var left = keyboard_check(ord("A")) || keyboard_check(vk_left) || gamepad_axis_value(0, gp_axislh) < -0.5
var up = keyboard_check(ord("W")) || keyboard_check(vk_up) || keyboard_check(vk_space) || gamepad_button_check(0, gp_face1)
var down = keyboard_check(ord("S")) || keyboard_check(vk_down) || gamepad_axis_value(0, gp_axislv) > 0.5 || gamepad_button_check(0, gp_face3)
